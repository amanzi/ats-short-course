...
- $D^{*}_i$: hydrodynamic dispersion coefficient of solute $i$ ($L^2/T$) `r fontawesome::fa("long-arrow-right")` .brand-red[`we specify it`]
...
<iframe src="imgs/dependency_transport_incomplete.html" width="1200" height="600" frameborder="0"></iframe>
]]
